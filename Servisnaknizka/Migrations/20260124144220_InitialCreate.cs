        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Permissions_Users_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartsUsed = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRecords_Users_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_ServiceId_VehicleId",
                table: "Permissions",
                columns: new[] { "ServiceId", "VehicleId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Permissions_VehicleId_IsActive",
                table: "Permissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_OwnerId_IsActive",
                table: "Vehicles",
